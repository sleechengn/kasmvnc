...
set -e
mkdir -p /opt/tmp
rm -rf /opt/tmp/kasmvnc-build
cp -r . /opt/tmp/kasmvnc-build
pushd /opt/tmp/kasmvnc-build
...
./build.sh 192.168.13.73:5000/sleechengn/kasmvnc:latest
docker push 192.168.13.73:5000/sleechengn/kasmvnc:latest
